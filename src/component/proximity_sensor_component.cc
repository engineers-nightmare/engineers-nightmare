...
proximity_sensor_component_stub
proximity_sensor_component_from_config(const config_setting_t *proximity_sensor_config) {
    proximity_sensor_component_stub proximity_sensor_stub{};
...
proximity_sensor_component_stub::register_generator() {
    component_stub_generators["proximity_sensor"] = proximity_sensor_component_from_config;
}
