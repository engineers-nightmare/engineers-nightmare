...
void
wire_power_component_manager::create_component_instance_data(unsigned count) {
...
void
wire_power_component_manager::destroy_instance(instance i) {
...
void
wire_power_component_manager::entity(c_entity e) {
    if (buffer.num >= buffer.allocated) {
        printf("Increasing size of wire_power buffer. Please adjust\n");
...
void
wire_power_component_stub::assign_component_to_entity(c_entity entity) {
    auto &man = component_system_man.managers.wire_power_component_man;
...
std::unique_ptr<component_stub> wire_power_component_stub::from_config(const config_setting_t *config) {
    auto wire_power_stub = std::make_unique<wire_power_component_stub>();

    return std::move(wire_power_stub);
}
