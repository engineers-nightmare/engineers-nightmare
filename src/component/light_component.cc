...
light_component_stub
light_component_from_config(const config_setting_t *light_config) {
    light_component_stub light_stub{};
...
light_component_stub::register_generator() {
    component_stub_generators["light"] = light_component_from_config;
}
