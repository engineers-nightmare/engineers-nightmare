...
struct power_sensor_component_manager : component_manager<power_sensor_component_manager> {
...
struct power_sensor_component_stub : component_stub {
    power_sensor_component_stub() = default;
