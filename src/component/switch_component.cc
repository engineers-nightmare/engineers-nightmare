...
switch_component_stub
switch_component_from_config(const config_setting_t *switch_config) {
    switch_component_stub switch_stub{};
...
switch_component_stub::register_generator() {
    component_stub_generators["switch"] = switch_component_from_config;
}
