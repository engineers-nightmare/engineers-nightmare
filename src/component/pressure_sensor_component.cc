...
pressure_sensor_component_stub
pressure_sensor_component_from_config(const config_setting_t *pressure_sensor_config) {
    pressure_sensor_component_stub pressure_sensor_stub{};
...
pressure_sensor_component_stub::register_generator() {
    component_stub_generators["pressure_sensor"] = pressure_sensor_component_from_config;
}
