...
gas_producer_stub_from_config(const config_setting_t *gas_producer_config) {
    auto gas_producer_stub = std::make_shared<gas_producer_component_stub>();
...
void
gas_producer_component_manager::register_stub_generator() {
    component_stub_generators["gas_producer"] = gas_producer_stub_from_config;
}
