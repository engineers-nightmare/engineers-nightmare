...
gas_production_component_stub
gas_production_component_from_config(const config_setting_t *gas_production_config) {
    gas_production_component_stub gas_production_stub{};

    auto gas_type_member = config_setting_get_member(gas_production_config, "gas_type");
    gas_production_stub.gas_type = config_setting_get_int(gas_type_member);

    auto flow_rate_member = config_setting_get_member(gas_production_config, "flow_rate");
    gas_production_stub.flow_rate = config_setting_get_float(flow_rate_member);

    auto max_pressure_member = config_setting_get_member(gas_production_config, "max_pressure");
    gas_production_stub.max_pressure = config_setting_get_float(max_pressure_member);

    return gas_production_stub;
};
...
gas_production_component_stub::register_generator() {
    component_stub_generators["gas_production"] = gas_production_component_from_config;
}
...
void
gas_production_component_manager::entity(c_entity e) {
