...
gas_production_stub_from_config(const config_setting_t *gas_production_config) {
    auto gas_production_stub = std::make_shared<gas_production_component_stub>();
...
gas_production_component_stub::register_generator() {
    component_stub_generators["gas_production"] = gas_production_stub_from_config;
}
