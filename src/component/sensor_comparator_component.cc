...
sensor_comparator_component_stub
sensor_comparator_component_from_config(const config_setting_t *sensor_comparator_config) {
    sensor_comparator_component_stub sensor_comparator_stub{};
...
sensor_comparator_component_stub::register_generator() {
    component_stub_generators["sensor_comparator"] = sensor_comparator_component_from_config;
}
