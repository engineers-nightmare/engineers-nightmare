...
sensor_comparator_stub_from_config(const config_setting_t *sensor_comparator_config) {
    auto sensor_comparator_stub = std::make_shared<sensor_comparator_component_stub>();
...
void
sensor_comparator_component_manager::register_stub_generator() {
    component_stub_generators["sensor_comparator"] = sensor_comparator_stub_from_config;
}
