...
struct door_slider_component_manager : component_manager<door_slider_component_manager> {
...
struct door_slider_component_stub : component_stub {
    door_slider_component_stub() = default;
