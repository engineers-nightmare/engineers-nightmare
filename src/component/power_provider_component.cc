...
power_provider_component_stub
power_provider_component_from_config(const config_setting_t *power_provider_config) {
    power_provider_component_stub power_provider_stub{};
...
power_provider_component_stub::register_generator() {
    component_stub_generators["power_provider"] = power_provider_component_from_config;
}
