...
relative_position_component_stub
relative_position_component_from_config(const config_setting_t *relative_position_config) {
    relative_position_component_stub relative_position_stub{};
...
relative_position_component_stub::register_generator() {
    component_stub_generators["relative_position"] = relative_position_component_from_config;
}
