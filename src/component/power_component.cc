...
power_component_stub
power_component_from_config(const config_setting_t *power_config) {
    power_component_stub power_stub{};
...
power_component_stub::register_generator() {
    component_stub_generators["power"] = power_component_from_config;
}
