    ...
    if (gas_producer_man.exists(entity)) {
        {
            ...
            add_filter(filters, 8, *(gas_producer.filter),
                "Gas Producer/filter");
            filters.back().entity = entity;
        }
    }
    ...
    if (light_man.exists(entity)) {
        {
            ...
            add_filter(filters, 7, *(light.filter),
                "Light/filter");
            filters.back().entity = entity;
        }
    }
    ...
    if (rotator_man.exists(entity)) {
        {
            ...
            add_filter(filters, 6, *(rotator.filter),
                "Rotator/filter");
            filters.back().entity = entity;
        }
    }
    ...
    if (rotator_stepped_man.exists(entity)) {
        {
            ...
            add_filter(filters, 1, *(rotator_stepped.step_up),
                "Stepped Rotator/step_up");
            filters.back().entity = entity;
        }
        {
            auto rotator_stepped = rotator_stepped_man.get_instance_data(entity);
            add_filter(filters, 2, *(rotator_stepped.step_down),
                "Stepped Rotator/step_down");
            filters.back().entity = entity;
        }
        {
            auto rotator_stepped = rotator_stepped_man.get_instance_data(entity);
            add_filter(filters, 3, *(rotator_stepped.value_driver),
                "Stepped Rotator/value_driver");
            filters.back().entity = entity;
        }
    }
...
void update_filter(filter_ui_state const& filter) {
    ...
    case 1: {
        ...
        if (rotator_stepped_man.exists(entity)) {
            auto rotator_stepped = rotator_stepped_man.get_instance_data(entity);
            rotator_stepped.step_up->set(filter);
        }
    } break;
    ...
    case 2: {
        ...
        if (rotator_stepped_man.exists(entity)) {
            auto rotator_stepped = rotator_stepped_man.get_instance_data(entity);
            rotator_stepped.step_down->set(filter);
        }
    } break;
    ...
    case 3: {
        ...
        if (rotator_stepped_man.exists(entity)) {
            auto rotator_stepped = rotator_stepped_man.get_instance_data(entity);
            rotator_stepped.value_driver->set(filter);
        }
    } break;
