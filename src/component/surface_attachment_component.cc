...
surface_attachment_component_stub
surface_attachment_component_from_config(const config_setting_t *surface_attachment_config) {
    surface_attachment_component_stub surface_attachment_stub{};
...
surface_attachment_component_stub::register_generator() {
    component_stub_generators["surface_attachment"] = surface_attachment_component_from_config;
}
