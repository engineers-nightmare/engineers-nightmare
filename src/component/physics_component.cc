...
physics_component_stub
physics_component_from_config(const config_setting_t *physics_config) {
    physics_component_stub physics_stub{};
...
physics_component_stub::register_generator() {
    component_stub_generators["physics"] = physics_component_from_config;
}
