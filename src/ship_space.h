...
struct ship_space {
    ...
    std::unordered_map<unsigned, std::set<unsigned>> entity_to_attach_lookups[num_wire_types];
    std::unordered_map<unsigned, std::set<unsigned>> &entity_to_power_attach_lookup =
